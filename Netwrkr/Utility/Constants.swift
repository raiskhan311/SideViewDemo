...
struct WEB_URL {
    static let BaseURL:NSString          = ""
    
    static let GetLiveTV:NSString         = "\(BaseURL)/"            as NSString
}

struct THEME_COLOR {
    static let pink:UIColor       = UIColor(red: 255/255, green: 60/255, blue: 104/255, alpha: 1)    
}
